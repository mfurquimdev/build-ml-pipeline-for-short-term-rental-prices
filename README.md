...
Link to GitHub repository: https://github.com/mfurquimdev/build-ml-pipeline-for-short-term-rental-prices
Link to wandb public project: https://wandb.ai/mfurquim/nyc_airbnb
...
```
git clone https://github.com/mfurquimdev/build-ml-pipeline-for-short-term-rental-prices.git
```
...
```bash
> mlflow run https://github.com/mfurquimdev/build-ml-pipeline-for-short-term-rental-prices.git \
